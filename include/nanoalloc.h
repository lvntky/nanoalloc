...
NA_EXTERN void *
na_alloc(size_t size) NA_ATTR_MALLOC NA_ATTR_ALLOC_SIZE1 NA_ATTR_WUR;

NA_EXTERN void na_free(void *ptr);

NA_EXTERN void *na_realloc(void *ptr,
			   size_t size) NA_ATTR_ALLOC_SIZE_2 NA_ATTR_WUR;

NA_EXTERN void *na_calloc(size_t nmemb, size_t size) NA_ATTR_MALLOC
	NA_ATTR_ALLOC_SIZE1_2 NA_ATTR_WUR; /* 1_2 — nmemb*size  */

#else /* override mode */

NA_EXTERN void *
malloc(size_t size) NA_ATTR_MALLOC NA_ATTR_ALLOC_SIZE1 NA_ATTR_WUR;

NA_EXTERN void free(void *ptr);

NA_EXTERN void *realloc(void *ptr,
			size_t size) NA_ATTR_ALLOC_SIZE_2 NA_ATTR_WUR;
